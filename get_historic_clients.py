...
# API endpoint for historic clients
clients_url = f"{controller_url}/proxy/network/v2/api/site/{site_name}/clients/history"
...
# Send GET request to retrieve historic clients
...
# CSV file path
csv_file_path = "data/historic_clients.csv"
...
print(f"Historic clients data saved to {csv_file_path}")